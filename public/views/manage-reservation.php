<?php
    if ($reservation) {
        ...
        <div class="manage-reservation-page">
            ...
            <p><strong>Event Date:</strong> <?php echo esc_html(date('Y-m-d', strtotime($event->event_date))); ?></p>
            <hr>
            <p><string>Guest Name:</strong> <?php echo esc_html($reservation->name); ?></p>
            <p><strong>Guest Email:</strong> <?php echo esc_html($reservation->email); ?></p>
